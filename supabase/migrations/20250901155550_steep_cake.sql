/*
  # Add Kambal Inasal Menu Items and Categories

  1. New Categories
    - Add dim-sum, noodles, rice-dishes, beverages categories for Kambal Inasal
...
-- First, add the new categories for Kambal Inasal
